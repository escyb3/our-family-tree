...
const defaultThemes = {
  light: { name: 'בהיר', bg: 'bg-gray-100', text: 'text-gray-800', primary: 'bg-indigo-600', secondary: 'bg-white', panel: 'bg-white', icon: <Sun size={20} />, textSecondary: 'text-gray-600' },
